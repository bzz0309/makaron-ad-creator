...
Use these beats in order: surprising result hook; one ordinary photo; open Makaron; choose a template; emotional result. Write the whole script as one first-person testimonial from the user or creator who supplied the photo. The speaker describes their own input, actions, and result; never refer to the depicted subject as a detached he/she/they, 佢, 彼, or 彼女. Lines 3 and 4 describe what the speaker did, not commands to the viewer. They are locked and must be exactly: English `Open Makaron.` / `Use the template.`; Japanese `Makaronを開いた。` / `テンプレートを選んだ。`; Hong Kong Cantonese `我打開 Makaron。` / `我揀咗個模板。`. The English action beats remain short declarative edit beats inside the first-person testimonial, never imperatives addressed to the viewer. English uses `I/my` elsewhere naturally, Cantonese uses `我/我嘅`, and Japanese establishes an explicit first-person speaker at least once before naturally omitting the pronoun. Keep line 2 under 2.3 spoken seconds. Adapt Japanese and Cantonese culturally; do not translate literally. Do not invent a feature, price, rating, endorsement, urgency, or claim.
